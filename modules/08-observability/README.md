# Module 08: LLM Observability and Tracing
...
- Understand the core concepts of LLM Observability and Tracing
...
### What is LLM Observability and Tracing?

LLM Observability and Tracing is a fundamental component of LLMOps CI/CD: Zero to Hero. In production environments, this skill is used daily by engineers to build, deploy, and maintain reliable systems.

**Real-world analogy:** Think of LLM Observability and Tracing like learning to read a map before navigating a city. Once you understand the fundamentals, you can find your way through any complex system.
...
```bash
ls modules/08-observability/lab/starter/
```
...
cd modules/08-observability/lab/starter/
```

**Step 3:** Verify the setup
```bash
# Run the validation to check your setup
bash modules/08-observability/validation/validate.sh
```
...
1. What is the main purpose of LLM Observability and Tracing?
...
**Next: [Module 09 →](../09-cicd-pipeline-build/)**
